...
**このステップの動作はたった1つ：「質問を1つ送ったら、発言を終える」。**

ユーザーの返信が届いたら、それを合図にまた1つだけ質問する。これを Q1 から Q9 まで繰り返すだけ。
1回の発言に質問を2つ以上入れない。返信が来る前に次へ進まない。

会話が途切れて再起動したときは、途中から再開せず**ステップ0からやり直す**。
